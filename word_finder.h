...
class IllegalWordChecker {
    public:
        IllegalWordChecker();
        explicit IllegalWordChecker(const std::list<std::wstring> &strlist);
        ~IllegalWordChecker() = default;
        IllegalWordChecker(const IllegalWordChecker &) = delete;
        IllegalWordChecker & operator=(const IllegalWordChecker &) = delete;
        void add(const std::wstring &str);
        std::wstring & filter(std::wstring &str) const;
